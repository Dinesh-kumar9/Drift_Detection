...
class DriftEvent(Base):
    ...
    detector_type = Column(String(50), nullable=True)
...
class AttributionReport(Base):
    ...
    ranked_stages = Column(JSONB, nullable=False)
...
class RetrainJob(Base):
    ...
    trigger_reason = Column(JSONB, nullable=True)
    cost_estimate = Column(Float, nullable=True)
    expected_gain = Column(Float, nullable=True)
